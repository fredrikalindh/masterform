...
const Privacy = () => {
  return (
    <Container maxWidth='md'>
      <Box pt={20} pb={10}>
        <Typography variant='h3' gutterBottom color='initial'>
          Papapal Privacy Policy
        </Typography>

        <Typography variant='caption'>
          This Privacy Policy describes how your personal information is
          collected, used, and shared when you visit or make a purchase from
          https://papapal.me (the “Site”).
        </Typography>
      </Box>
      <Box py={2}>
      ...
      <Box py={2}>
        ...
        <Typography variant='body1'>
          ...
          by e-mail at mathis@papapal.me or by mail using the details provided
          below:
        </Typography>
      </Box>
    </Container>
